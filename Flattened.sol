...
contract Boatxyz is ERC721, ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    // Define a maximum number of mintable NFTs
    uint256 public MAX_SUPPLY = 10;

    constructor() ERC721("Boatxyz", "BTX") {}

    function safeMint(address to, string memory uri) public {
        // Ensure that no more NFTs than the MAX_SUPPLY can be minted
        require(_tokenIdCounter.current() <= MAX_SUPPLY, "Sorry, max supply was reached.");
